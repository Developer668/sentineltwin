import { Bell, ChevronDown, CircleHelp, CloudSun, LogIn, LogOut, Play, Satellite } from 'lucide-react'
...
export function Header({ runtime, auth, currentTime, onRunSimulation, onAssessSatellite, onAuthAction, onInfo }: HeaderProps) {
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-actions">
        <div className={`memory-health ${runtime.source}`} title={runtime.detail}>
        ...
        <span className={`source-tag ${runtime.source}`}>{runtime.label}</span>
        {auth.enabled && (
